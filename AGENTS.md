...
They can also write Python or SQL in the hosted editor (hidden tests, Run / Submit) and use the in-app mock interviewer. Still do not dump a full solution into the editor for them unless they ask.
